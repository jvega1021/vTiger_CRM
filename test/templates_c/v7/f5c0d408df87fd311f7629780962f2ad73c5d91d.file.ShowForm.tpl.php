<?php /* Smarty version Smarty-3.1.7, created on 2017-10-03 13:25:05
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/Webforms/ShowForm.tpl" */ ?>
<?php /*%%SmartyHeaderCode:193728706559d38fb11b9387-50694360%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5c0d408df87fd311f7629780962f2ad73c5d91d' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/Webforms/ShowForm.tpl',
      1 => 1506436381,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '193728706559d38fb11b9387-50694360',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59d38fb135689',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59d38fb135689')) {function content_59d38fb135689($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/vtigercrm/libraries/Smarty/libs/plugins/modifier.replace.php';
?>
<div class="modal-dialog modelContainer">  
    <?php ob_start();?><?php echo vtranslate(('SINGLE_').($_smarty_tpl->tpl_vars['MODULE']->value),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['RECORD_MODEL']->value->get('name');?>
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['HEADER_TITLE'] = new Smarty_variable((($_tmp1).(" - ")).($_tmp2), null, 0);?>
...
<pre>
        ...
        <form id="__vtigerWebForm" name="<?php echo $_smarty_tpl->tpl_vars['RECORD_MODEL']->value->getName();?>
...
<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('required')==1){?>*<?php }?></label></td><?php }?>
                        <td>
                            <?php if (($_smarty_tpl->tpl_vars['DATA_TYPE']->value=='picklist'||$_smarty_tpl->tpl_vars['DATA_TYPE']->value=='multipicklist')){?>
								...
								<?php $_smarty_tpl->tpl_vars['PICKLIST_VALUES'] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_INFO']->value['picklistvalues'], null, 0);?>
								<?php $_smarty_tpl->tpl_vars['FIELD_INFO'] = new Smarty_variable(Vtiger_Util_Helper::toSafeHTML(Zend_Json::encode($_smarty_tpl->tpl_vars['FIELD_INFO']->value)), null, 0);?>
...
<?php $_tmp4=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['FIELD_LABEL'] = new Smarty_variable($_tmp4, null, 0);?>
                                    <?php ob_start();?><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['FIELD_LABEL']->value,' ','_');?>
<?php $_tmp5=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['PICKLIST_DATA_LABEL'] = new Smarty_variable("label:".$_tmp5, null, 0);?>
                                <?php }else{ ?>
                                    <?php $_smarty_tpl->tpl_vars['PICKLIST_DATA_LABEL'] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name'), null, 0);?>
                                <?php }?>
                            <?php }elseif(($_smarty_tpl->tpl_vars['DATA_TYPE']->value=="salutation")||($_smarty_tpl->tpl_vars['DATA_TYPE']->value=="string")||($_smarty_tpl->tpl_vars['DATA_TYPE']->value=="time")||($_smarty_tpl->tpl_vars['DATA_TYPE']->value=="currency")||($_smarty_tpl->tpl_vars['DATA_TYPE']->value=="url")||($_smarty_tpl->tpl_vars['DATA_TYPE']->value=="phone")){?>
                                <?php $_smarty_tpl->tpl_vars['TYPE'] = new Smarty_variable("text", null, 0);?>
                            <?php }elseif(($_smarty_tpl->tpl_vars['DATA_TYPE']->value=="text")){?>
                                <?php $_smarty_tpl->tpl_vars['TYPE'] = new Smarty_variable("text", null, 0);?>
                                <textarea name="<?php echo urlencode($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName());?>
" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('required')==1){?> required<?php }?> 
                            ...
                            <?php }elseif(($_smarty_tpl->tpl_vars['DATA_TYPE']->value=="date")){?>
                                <?php $_smarty_tpl->tpl_vars['TYPE'] = new Smarty_variable("date", null, 0);?>
                            <?php }?>
...
" <?php if (in_array(Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value),$_smarty_tpl->tpl_vars['FIELD_VALUE_LIST']->value)){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
                            ...
                            <?php }elseif($_smarty_tpl->tpl_vars['DATA_TYPE']->value=="reference"){?>
                                <input type="hidden" name="<?php echo urlencode($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName());?>
...
" readonly= />
                            <?php }elseif($_smarty_tpl->tpl_vars['DATA_TYPE']->value=="image"){?>
                                <input type="file" name="<?php echo urlencode($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName());?>
[]" data-label="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('neutralizedFieldName');?>
...
" data-label="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('neutralizedFieldName');?>
" value=1 <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')=="on"){?> checked <?php }?> <?php if (($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('required')==1)||($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory(true))){?> required<?php }?>/>
                                <?php }?>
...
">
    ...
    <div class="modal-footer">
        <center>
            <a href="#" class="cancelLink" type="reset" data-dismiss="modal"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a>
        </center>
        </div>
    </div>
