<?php /* Smarty version Smarty-3.1.7, created on 2017-09-26 15:23:32
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/Workflows/FieldExpressions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:100123871659ca70f47e4ed1-97559298%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e2b5ba4d2010498823e38c42db183173e05a8a08' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/Workflows/FieldExpressions.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '100123871659ca70f47e4ed1-97559298',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ca70f4848e7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ca70f4848e7')) {function content_59ca70f4848e7($_smarty_tpl) {?>
...
<div class="modal-body"><div class="row"><div class="col-sm-4"><select class="textType"><option data-ui="textarea" value="rawtext"><?php echo vtranslate('LBL_RAW_TEXT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"><option></option><?php  $_smarty_tpl->tpl_vars['MODULE_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['MODULE_FIELD']->_loop = false;
...
</option><?php } ?></select></span><?php }?></div><div class="col-sm-4 hide useFunctionContainer"><select class="useFunction" data-placeholder="<?php echo vtranslate('LBL_USE_FUNCTION',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
"><option></option><?php  $_smarty_tpl->tpl_vars['FIELD_EXPRESSIONS_KEY'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_EXPRESSIONS_KEY']->_loop = false;
