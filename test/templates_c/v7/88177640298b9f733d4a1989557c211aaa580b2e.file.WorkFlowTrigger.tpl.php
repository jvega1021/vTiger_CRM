<?php /* Smarty version Smarty-3.1.7, created on 2017-09-26 15:23:31
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/Workflows/WorkFlowTrigger.tpl" */ ?>
<?php /*%%SmartyHeaderCode:107873903159ca70f3b8afe5-12958483%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '88177640298b9f733d4a1989557c211aaa580b2e' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/Workflows/WorkFlowTrigger.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '107873903159ca70f3b8afe5-12958483',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ca70f3cfb39',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ca70f3cfb39')) {function content_59ca70f3cfb39($_smarty_tpl) {?>
...
</label><div class="col-sm-5 controls"><?php $_smarty_tpl->tpl_vars['SINGLE_SELECTED_MODULE'] = new Smarty_variable("SINGLE_".($_smarty_tpl->tpl_vars['SELECTED_MODULE']->value), null, 0);?><span><input type="radio" name="workflow_trigger" value="1" <?php if ($_smarty_tpl->tpl_vars['EXECUTION_CONDITION']->value=='1'){?> checked="" <?php }?>> <span id="workflowTriggerCreate"><?php echo vtranslate($_smarty_tpl->tpl_vars['SINGLE_SELECTED_MODULE']->value,$_smarty_tpl->tpl_vars['SELECTED_MODULE']->value);?>
...
)</span><br><span><input type="radio" name="workflow_trigger" value="6" <?php if ($_smarty_tpl->tpl_vars['EXECUTION_CONDITION']->value=='6'){?> checked="" <?php }?>> <?php echo vtranslate('LBL_TIME_INTERVAL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></div></div><div class="form-group workflowRecurrenceBlock <?php if (!in_array($_smarty_tpl->tpl_vars['EXECUTION_CONDITION']->value,array(2,3))){?> hide <?php }?>"><label for="name" class="col-sm-3 control-label"><?php echo vtranslate('LBL_RECURRENCE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
